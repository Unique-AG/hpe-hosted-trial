...
assert_yaml_value "2-applications/1-configuration-backend/app.yaml" '.spec.source.helm.valuesObject.extraObjects[] | select(.metadata.name == "configuration-theme-hpe") | .kind' "Job"
assert_yaml_value "2-applications/1-configuration-backend/app.yaml" '.spec.source.helm.valuesObject.extraObjects[] | select(.metadata.name == "configuration-theme-hpe") | .metadata.annotations."argocd.argoproj.io/hook"' "PostSync"
assert_yaml_value "2-applications/1-configuration-backend/app.yaml" '.spec.source.helm.valuesObject.extraObjects[] | select(.metadata.name == "configuration-theme-hpe") | .spec.template.spec.containers[0].env[0].valueFrom.secretKeyRef.name' "configuration-backend-connections"
assert_file_contains "2-applications/1-configuration-backend/app.yaml" "'color-primary-cta', '#01A982'"
assert_file_contains "2-applications/1-configuration-backend/app.yaml" "'color-background', '#FFFFFF'"
assert_file_contains "2-applications/1-configuration-backend/app.yaml" "HPE_logo_full-clr_pos_rgb\\.svg"
