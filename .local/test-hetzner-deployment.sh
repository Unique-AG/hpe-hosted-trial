...
assert_file_contains "${REPOSITORY_DIR}/set-hostname.sh" 'CONTENT_SECURITY_POLICY_VALUE'
assert_file_contains "${REPOSITORY_DIR}/set-hostname.sh" 'frontend CSP.*does not allow'
